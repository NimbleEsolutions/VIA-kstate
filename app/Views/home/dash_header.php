...
<head>
  ...
  <title>VIA  | <?= ($uri->getSegment(1) == 'home' ? 'Home' : null)?> <?= ($uri->getSegment(1) == 'user' ? 'User Details' : null)?> <?= ($uri->getSegment(1) == 'translations' ? 'VIA Translations' : null)?> </title>
...
<body class="hold-transition layout-top-nav">
  ...
  <div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white" style="background-color: #005120;">
      <div class="container">
        <a href="" class="navbar-brand">
          <img src="<?= base_url(); ?>/public/dist/img/via-asa-logo.png" alt="Ozone Logo" >
          ...
          <ul class="navbar-nav">
            ...
            <?php if(session()->get('role_id') == '5'){ ?>
              <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle <?= ($uri->getSegment(1) == 'translations' ? 'active' : null)?>">VIA Translations</a>
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                  <li><a href="<?= site_url('translations/via_definations');?>" class="dropdown-item">VIA Definations </a></li>            
                  <li><a href="<?= site_url('translations/guidlines');?>" class="dropdown-item">Parent Teachers Guide</a></li>            
                </ul>
              </li>
            <?php } ?>
            <?php if(session()->get('role_id') == '1' || session()->get('role_id') == '2'){ ?>
              <li class="nav-item dropdown">
                ...
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="<?= site_url('user/translator_details');?>" class="dropdown-item">Translator Requests </a></li>            
                </ul>
              </li>
            <?php } ?>
          </ul>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          ...
          <li class="nav-item dropdown user-menu" style="text-align: center;">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" style="    padding: 0rem 1rem;">
              ...
              <div class="row">
                <div class="col-lg-10" style="text-align: center;padding: .8rem .4rem;">
                  <span class="d-none d-md-inline"><?= $user[0]['user_firstName']." ".$user[0]['user_lastName']; ?><!-- <br>(Sales Executive) --></span>                
                </div>
                <div class="col-sm-2" style="padding: .8rem .4rem;">                
